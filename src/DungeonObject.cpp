...
DungeonObject::DungeonObject()
{
    ...
    for (int x = 0; x < MON_POPULATION; x++)
    {
        ...
        switch (in_type)
       {
            ...
            case 2:
                ...
                break;
           case 3:
                monsterArray[x].setMonsterStats(20,6,40,"Poltergeist","Life Drain","Wraith");
                c_type = WRMONSTER;
                break;
        }
    ...
    Wraith1.setMonsterStats(20,6,40,"Poltergeist","Life Drain","Wraith");
}
    ...
    while (!goodInput)
    {
        ...
        switch(classInt)
        {
            case '1':
                ...
                PlayerOne.setPlayerStats(30,110,10,"Shield","Sword", "Shield Bash");
...
bool DungeonObject::displayEncounter()
{
    ...
    switch (encounter)
    {
        ...
        case MURMONSTER: // opens ACII art for Murlock encounter
            ...
            if (!monsterArt)
            {
                cout << "Murlock Art file not found" << endl;
            }
            else
            {
                for (int x = 0; x < 13; x++)
        ...
        case WRMONSTER: // opens ACII art for Wraith encounter
            ...
            if (!monsterArt)
            {
                cout << "Wraith Art file not found" << endl;
            }
            else
            {
