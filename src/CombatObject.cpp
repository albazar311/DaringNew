   ...
   while (choiceFlag)
   {
        ...
        switch(weaponChoice)
        {
            ...
            case 'r':
               ...
               switch(comPerson->getAttackDmg())
               {
                    case 30:
                        weaponArt.open(SWORDART);
                        if (!weaponArt)
                        {
                            cout << "Art file not found" << endl;
                        }
                        else
                        {
                            for (int x = 0; x < 7; x++)
                            {
                            getline(weaponArt,artLine);
                            cout << artLine << endl;
                            }
                            weaponArt.close();
                            break;
